...
struct OnboardingView: View {
    ...
    private let pages: [Page] = [
        Page(icon: "calendar.badge.plus", title: "Count to the dates that matter", subtitle: "Birthdays, deadlines, holidays, anniversaries — all in one list."),
        Page(icon: "calendar", title: "Just the days", subtitle: "Open the app, glance, close. No clutter, no notifications, no nudges."),
